 ...
 */
public class CheckGoing {
    public String going  ;

    public void getData(String ID ,String event_id){
        String result = "";
        ...
        try{
            ...
            HttpPost httppost =
                    new HttpPost("http://partyhelper.xpoliem.com/android/checkGoing.php?my_id="+ID+"&event_id="+event_id); //onthou om reg te maak
